...
import { walletSearch } from "../../redux/wallet/thunkActions";




const Send = ({ isPanelActive, setIsPanelActive, type, showSummary }) => {
    ...
    const { isLoading, walletName } = useSelector(state => state.walletReducer)
    ...
    useEffect(() => {
        if (values.address) {
            const data = {
                currency_id: oneWallet?.currency_id,
                address: values.address
            }
            dispatch(walletSearch(data))
        }
    }, [values])
                ...
                <KeyboardAvoidingView
                    ...
                    <ScrollView >
                        <View style={styles.container}>
                            ...
                            {
                                walletName?.name && <Text style={styles.header}>{walletName?.name}</Text>
