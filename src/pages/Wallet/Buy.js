...
const Buy = ({ isPanelActive, setIsPanelActive, type, showSummary }) => {
        ...
        <>
            <SwipeablePanel {...panelProps} isActive={isPanelActive}>
                <View style={styles.container}>
                    <Text style={styles.header}>Enter the amount you want to buy</Text>
                    ...
                    <View style={{ width: '90%' }}>
                        ...
                        <DropDownPicker
                            ...
                            style={styles.input}
                        />
                        <Input label='Buy' showType={true} type={type} />
                        <View style={styles.flex_1}>
                            <View style={{flexGrow: 1, marginRight: 10}}>
                                <Input type='money' placeholder='Amount' label='Amount to pay in Naira' />
                            </View>
                        ...
                        <Text style={[styles.text, { textAlign: 'center', marginTop: 40 , color: colors.success}]}>
                            Buy {type} at 909/$
                        </Text>
                    </View>
